...
import org.example.backend.service.ChatHistoryService;
...
public class ChatController {
    ...
    public ResponseEntity<ApiResponse<ChatResponse>> chat(@RequestBody ChatRequest request) {
        try {
            ...
            chatHistoryService.saveMessagePair(request.getId(), request.getQuestion(), fullAnswer);
    ...
    public ResponseEntity<ApiResponse<String>> clearChatHistory(@RequestBody ClearRequest request) {
        try {
            ...
            if (session != null) {
                ...
                chatHistoryService.clearSessionHistory(request.getId());
